...
public class TwinErrInjModuleJVMRunner extends TwinErrInjTests
{
    public TwinErrInjModuleJVMRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
